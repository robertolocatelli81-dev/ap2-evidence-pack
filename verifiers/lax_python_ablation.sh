#!/bin/bash
# Ablation (README): each strict layer of the reference removed ALONE from a copy — (1) file-level strict JSON, (2) JWT-level strict
...
if L == "file_json": s = s.replace("def loads_strict(text: str):", "def loads_strict(text: str):\n    return json.loads(text)\n\ndef _ablated_1(text):")
