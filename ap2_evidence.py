...
HONEST_SCOPE = (
    ...
    "artifact verifies and the SEALED CONTENT is intact — NOT that the file as a whole is unaltered (the anchor block lies "
    "outside the digest), NOT that the mandates form a bound "
